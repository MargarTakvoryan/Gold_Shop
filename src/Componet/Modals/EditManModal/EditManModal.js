...
import styles from './EditManModal.module.css'
import axios from 'axios'
import { AiOutlineClose } from 'react-icons/ai';
import { RiImageAddLine } from 'react-icons/ri';

function EditManModal({editManCategory,setEditModalOpen,filterCategoryId}) {
    ...
    return (
        <div className={styles.modal} onClick={()=>{
            ...
            <div className={styles.modalContiner} onClick={(e)=>{
                ...
                <button onClick={(e)=>{
                    // e.preventDefault()
                    editManCategory(filterCategoryId,category)
                    setEditModalOpen(false)
                }}>Добавить</button>
            </div>
